...
function download_latest_files() {
    ...
    git clone -b packetbridge --depth 1 https://github.com/furest/tbWebgui /tmp/raspap-webgui || install_error "Unable to download files from github"
...
function patch_system_files() {
	...
	"/usr/bin/pkill -F /tmp/packetbridge.pid"
    )
